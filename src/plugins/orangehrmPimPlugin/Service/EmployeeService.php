...
class EmployeeService
{
    ...
    {
        $id = $this->getEmployeeDao()->getOrganizationId();
        ...
        // $mailer->body = `<p><b>Hello {$employee_name},</b></p>`;
        ...
        // $mailer->body .= '<p>website: cradletalent.com</p>';
        // $mailer->body .= `<p>Email: {$employee_email}</p>`;
        // $mailer->body .= `<pPassword: {$employee_password}</p>`;
        // $mailer->body .= '<p>Cheers!<br>Cradle Team</p>';

        // $mailer->sendEmail($employee_email, $employee_name);
