...
class User
{
    ...
    public const USER_ORGANIZATION_ID = 'user.user_organizationId';

    public const FLASH_LOGIN_ERROR = 'flash.login_error';

    public const FLASH_SIGNUP_ERROR = 'flash.signup_error';
    ...
    {
        return $this->getAttribute(self::USER_ORGANIZATION_ID);
    }
    ...
    {
        $this->setAttribute(self::USER_ORGANIZATION_ID, $organizationId);
    }
