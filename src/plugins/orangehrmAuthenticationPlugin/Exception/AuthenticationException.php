...
class AuthenticationException extends Exception
{
    ...
    public const ORGANIZATION_EXIST = 'organization_already_exists';
    ...
    public static function organizationExist():self
    {
        return new self(self::ORGANIZATION_EXIST, 'Organization Already Exists');
    }
}
