...
use OrangeHRM\Authentication\Controller\LogoutController;
...
class SessionSubscriber extends AbstractEventSubscriber
{
    ...
    public function onRequestEvent(RequestEvent $event)
    {
        ...
        // uncomment the bottom code is you want the session to log the user out once the time has been exceeded.
